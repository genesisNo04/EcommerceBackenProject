...
public class ProductTestUtils {
    ...
    public static ProductRequestDTO createTestProductDTO(String productName, String description, BigDecimal price, Integer quantity, String imgUrl) {
        return new ProductRequestDTO(productName, description, quantity, Set.of(1L, 2L), price, imgUrl);
    }
}
