...
public enum SortableFields {
    PRODUCT(Set.of("id", "productName", "price", "stockQuantity", "createdAt")),
    ...
    ADDRESS(Set.of("id", "street", "city", "state", "country", "zipCode", "createdAt")),
    USER(Set.of("id", "username", "email", "firstName", "lastName")),
    CATEGORY(Set.of("id", "name"));
